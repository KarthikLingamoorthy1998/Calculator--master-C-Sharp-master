...
namespace Calculator_16CS125
{
    public partial class Intro : Form
    {
        ...
        private void arithmeticToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form1 t = new Form1();
            t.MdiParent = this;
            t.Show();
        ...
        private void trignometricToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Trignometric tt = new Trignometric();
            tt.MdiParent = this;
            tt.Show();
        }
